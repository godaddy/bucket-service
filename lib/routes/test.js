...
const getObjForTag = require('../utils').getObjForTag;
const extractTags = require('../utils').extractTags;
const filterTags = require('../utils').filterTags;
...
function updateOne({ params, body }, res, callback) {
  ...
  TestModel.find({ uuid: uuid, project: project }, (findErr, tests) => {
    if (findErr) {
      ...
      const test = tests[0];
      if (Object.prototype.hasOwnProperty.call(body, 'name') && body.name) test.name = body.name;
      if (Object.prototype.hasOwnProperty.call(body, 'project') && params.project) test.project = params.project;

      if (Object.prototype.hasOwnProperty.call(body, 'bucket') && body.bucket) {
      ...
      if (Object.prototype.hasOwnProperty.call(body, 'appArea') && body.appArea) {
